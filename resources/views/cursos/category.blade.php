<x-app-layout>
    ...
    <div class="container bg-gray-200  mx-auto px-2 sm:px-6 lg:px-8 text-black py-4">
        <h2 class="text-2xl text-green-800 font-bold text-center">Cursos de {{ $category->nombre }}</h2>
        <div class="grid grid-cols-4 gap-5">
            @foreach ($cursoCategory as $curso)
    ...
    {{-- <livewire:curso-category-component :data="$cursoCategory" /> --}}
